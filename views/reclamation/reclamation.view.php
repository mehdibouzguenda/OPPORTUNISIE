...
<main>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <form action="reclamation.view.php" method="GET">
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($reclamations as $reclamation) { ?>
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="/BidenBU/reclamation">
        ...
        <div id="addReclamationModal" class="modal" etat="en attente">
            <div class="modal-content">
                ...
                <form id="addReclamationForm" method="POST" action="/BidenBU/reclamation">
