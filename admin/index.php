                ...
                <tbody>
                    <?php foreach ($jobs as $job) : ?>
                        <tr>
                            ...
                            <td>
                                <span><i class="<?php echo $icons[$job['job_type']]; ?>"></i> <?php echo strtolower($job['job_type']); ?></span><br>
                            </td>
                            <td>
